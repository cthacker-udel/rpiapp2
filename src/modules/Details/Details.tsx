/**
 * @file Represents the details of the project. Describes the background and current status.
 */
 ...
 */
export const Details = (): React.JSX.Element => (
    <div className="flex flex-col flex-grow justify-center items-center">
        <div className="hidden lg:flex w-2/3 h-2/3">
            ...
            <div className="px-10 divider divider-horizontal" />
        ...
        <div className="lg:hidden flex flex-col gap-10 w-2/3 h-2/3">
            <article className="prose">
                <h1 className="text-xl text-wrap md:text-nowrap">
